...
public class Connection {
    ...
    public Connection(Node first, Node second, Vector<Short> first_i, Vector<Short> second_i){
        this.first = first;
        this.second = second;
    ...
    public Connection(Node first, Node second, short first_r, short first_c, short second_r, short second_c ){
        this.first = first;
        this.second = second;
