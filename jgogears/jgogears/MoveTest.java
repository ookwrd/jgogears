...
public class MoveTest extends TestCase {
	...
	public void testGTPConstructor() throws ParseException {
		...
		assertTrue(("" + new Move("black q10").getRow()), new Move("black q10").getRow() == 15);
		assertTrue(("" + new Move("black q10").getColumn()), new Move("black q10").getColumn() == 9);
	...
	public void testStringConversions() throws ParseException {
		for (int i = 0; i < 25; i++) {
			for (int j = 0; j < 25; j++) {
				...
				assertNotNull(move2);
				assertTrue("" + i + " " + j + " " + move + " " + move2, move2.getRow() == i);
				assertTrue("" + i + " " + j + " " + move + " " + move2, move2.getColumn() == j);
	...
	public void testToString() throws ParseException {
		...
		assertTrue(new Move(0, 0, BoardI.VERTEX_WHITE).toString().compareTo("white a1") == 0);
		assertTrue(new Move(18, 18, BoardI.VERTEX_WHITE).toString().compareTo("white t19") == 0);
	}
