 ...
 * 
 * It does NOT represent the number of prisoners, the number (or order) of previous moves
 * or whose turn it is too play.
 * 
 * @author stuart
 */
    ...
    public int setColour(int row, int column, short colour) { 
       ...
       int result = getColour(row,column);
        ...
        if (column >= this.getSize())
            throw new Error("Bad board size " + column + "/" + this.getSize() + " " );
