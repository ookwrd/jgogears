...
public class GTPState {
    ...
    public boolean check() {
        if (this.board == null) throw new Error("Illegal GTPState state");
        ...
        if (this.komi < 10000 && this.komi > 10000)
            throw new Error("Illegal GTPState state");
        if (this.mainTime < 0) throw new Error("Illegal GTPState state");
        if (this.byoYomiTime < 0) throw new Error("Illegal GTPState state");
        if (this.byoYomiStones < 0) throw new Error("Illegal GTPState state");
